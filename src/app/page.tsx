    ...
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
        <div className="max-w-xl w-full text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">Welcome Back to Daygo</h1>
          <p className="text-gray-400 mb-8">Continue your journaling journey and track your progress.</p>
          <Button className="px-8 py-6 text-lg" onClick={handleGoToDashboard}>
